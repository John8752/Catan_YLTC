...
import { createBaseGame, resourceAmounts, type GameEventRecord, type GameState } from "@catan/game-core/catan";
import { projectGameForPlayer, type CatanSettlementV1 } from "@catan/protocol/catan";
