...
- Catan supports map zoom. Do not require phone minimum font/icon sizes or subjective clarity checks at the default zoom. Retain interaction, containment, occlusion and proportional scaling regression; desktop typography checks remain applicable.
