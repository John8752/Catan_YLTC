import { RESOURCE_TYPES, type ResourceHand, type ResourceType } from "@catan/game-core/catan";
import { describeAction, victoryWarningTier, type GameCommand, type GameView } from "@catan/protocol/catan";
