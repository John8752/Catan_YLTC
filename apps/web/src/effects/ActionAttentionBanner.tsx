...
export function ActionAttentionBanner({ notice, victoryNotice = null }: { readonly notice: ActionAttentionEffectView | null; readonly victoryNotice?: VictoryWarningEffectView | null }) {
  ...
  return (
    <div className="pointer-events-none relative z-20 flex h-6 shrink-0 items-center justify-center" data-attention-slot="true" role="status" aria-live="polite" aria-atomic="true">
      {notice === null ? (victoryNotice === null ? null : <VictoryWarningNotice notice={victoryNotice} />) : (
