...
export function BankSupply({ resources }: { readonly resources: ResourceHand }) {
  return (
    <section
      className="mr-auto flex min-w-0 items-center gap-1 rounded-lg border border-white/15 bg-[#173f42]/72 p-1 shadow-sm backdrop-blur-sm lg:gap-1.5 lg:rounded-xl lg:p-1.5"
      aria-label="银行剩余资源"
