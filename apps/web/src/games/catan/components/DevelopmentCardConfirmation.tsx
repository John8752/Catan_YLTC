...
import type { GameCommand, GameView } from "@catan/protocol/catan";
...
import { RESOURCE_TYPES, emptyResourceHand, type ResourceHand, type ResourceType } from "@catan/game-core/catan";
