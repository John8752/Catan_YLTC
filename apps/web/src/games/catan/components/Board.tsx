import type { ActionAttentionEffectView, GameCommand, GameView, VictoryWarningEffectView } from "@catan/protocol/catan";
...
import { DEFAULT_BOARD_SCALE, useBoardViewport } from "../use-board-viewport.js";
import {
  axialToPixel,
  BOARD_HEX_SIZE,
  BoardPorts,
