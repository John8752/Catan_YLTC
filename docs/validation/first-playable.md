...
- Board readability: every number token displays one through five dice-probability pips, wool terrain uses a recognizable sheep silhouette and coastal ports use larger ratio-first signs with compact resource marks.
