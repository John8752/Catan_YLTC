import type { AnyRoomView, RoomView, PlayerSessionResponse } from "@catan/protocol";
...
export class RoomRegistry extends PlatformRegistry {
  ...
  override joinRoom(...args: Parameters<PlatformRegistry["joinRoom"]>): PlayerSessionResponse { const session = super.joinRoom(...args); return { ...session, room: catan(session.room) }; }
