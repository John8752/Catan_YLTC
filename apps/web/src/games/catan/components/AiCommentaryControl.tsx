import { AI_COMMENTARY_MODES, type AiCommentaryMode, type PublicSetupAnalysisView, type RoomView, type TableIntentContent } from "@catan/protocol/catan";
import { BrainCircuit, Crosshair, RefreshCw, Sparkles, Trophy } from "lucide-react";
import { useEffect, useLayoutEffect, useRef, useState, type RefObject } from "react";
import { requestAiCommentary } from "../api.js";
