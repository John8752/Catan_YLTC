...
describe("finite bank production", () => {
  it("withholds one resource from everyone when the bank cannot satisfy all claims", () => {
    ...
    const result = resolveProductionClaims(bank, [
      { playerId: "player_1", resource: "ore", amount: 2, hexId: "hex_1", vertexId: "vertex_1" },
      { playerId: "player_2", resource: "ore", amount: 1, hexId: "hex_1", vertexId: "vertex_2" },
      { playerId: "player_2", resource: "grain", amount: 1, hexId: "hex_2", vertexId: "vertex_2" },
    ]);
