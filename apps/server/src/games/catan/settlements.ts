import type { GameEvent, GameState } from "@catan/game-core/catan";
import { CATAN_GAME_ID, projectGameSummary, type CatanSettlementV1 } from "@catan/protocol/catan";
import { type MatchRecord } from "@catan/protocol/platform";
import type { MatchParticipant } from "../../database/match-repository.js";
import type { CatanRoomRecord } from "./room-types.js";

export function prepareSettlement(room: CatanRoomRecord, state: GameState, events: readonly GameEvent[], finishedAt: number):
