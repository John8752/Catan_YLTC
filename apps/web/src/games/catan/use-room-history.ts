import type { CatanRoomSync } from "./room-sync.js";
import { useEffect, useRef, useState } from "react";
import type { RoomView } from "@catan/protocol/catan";
import { type PlayerSession } from "../../room-session.js";
import { getRoomHistory } from "./api.js";
import { RoomSessionChangedError } from "../../room-updates.js";

export function useRoomHistory(session: PlayerSession | null, room: RoomView | null, updates: CatanRoomSync) {
