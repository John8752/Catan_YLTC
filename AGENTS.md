...
- Use the shared matrix in `tests/e2e/viewport-cases.ts`, not ad hoc substitute sizes. Logical full-canvas baselines are 393×852 and 440×956 CSS px, respectively, with both orientations and DPR 3. Never use physical raster resolution as the CSS viewport or increase UI sizes based on DPR.
